...
const getStatusColor = (status) => {
  ...
  const handleAcceptPhoto = async () => {
    try {
      ...
      const response = await client.post(`v3/update-photo-active`, payload);
  ...
  return (
    <>
      <div style={{ width: "100%", display: "flex", flexDirection: "row", justifyContent:"space-between", alignItems:"center"}}>
        ...
        <Button
          variant="contained"
          style={{ marginLeft: 12, backgroundColor: "Green", color: 'white', opacity: selectedPhotos.length === 0 ? 0.3 : 1 }}
